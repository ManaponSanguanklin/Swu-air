...
$booking_query="insert into books (email,class,booking_name,Age,type_of_identification,id_number,phone_number,source,destination,plane_id1,total_fare,anum,cnum,dtd1,dta1,flight_id) values ('$email','$class','$booking_name','$age','$type_of_identity_card','$id_number','$phone','$source','$destination','$plane_id','$total_fare','$anum','$cnum','$date_of_depart $time_of_depart','$date_of_arrival $time_of_arrival','$flight_id')";
$insert=mysqli_query($con,$booking_query);
