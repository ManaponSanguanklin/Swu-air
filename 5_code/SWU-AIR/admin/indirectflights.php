...
<link rel="stylesheet" type="text/css" href="../layoutsstyle.css">
 ...
 <body>
		...
		<form class="container"action = "direct-indirect-flights-backend.php" method = "POST" style="max-width: 1100px!important">
			...
			<h4 class="header" style="background-color: #333;color:white"><?php echo"Enter Details of Plane Starting From ".$source." to Intermediate Station"; ?></h4>
			...
			<h4 class="header" style="background-color: #333;color:white"><?php echo"Enter Details of Plane Starting From Intermediate Station to ".$destination; ?></h4>
