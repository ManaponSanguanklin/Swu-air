...
$time_of_depart=$_POST["time"];
 ...
 $sql=mysqli_query($con, "delete from  has_booked_seats_in_plane  where flight_id ='$flight_id'");
 $sql=mysqli_query($con, "delete from  books  where flight_id ='$flight_id'");
...
require_once "manageflights.php";
?>